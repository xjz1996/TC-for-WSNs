...
def performance_k():
    ...
    for i in x:
        ...
        y_debak[0].append(np.mean(y_debak_[0]))
        ...
        y_debak[1].append(np.mean(y_debak_[1]))
        ...
        y_debak[2].append(np.mean(y_debak_[2]))
        ...
        y_debak[3].append(np.mean(y_debak_[3]))
        ...
        y_debak[4].append(np.mean(y_debak_[4]))
